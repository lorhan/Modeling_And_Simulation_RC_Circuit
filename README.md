...
At the time of writing, the usage is as follows:"./main.exe"

1. **Building the C++ application:** insert the values of resistance, capacitance, etc in the file main.cpp. Then, compile the code and produce the executable with **"g++ main.cpp electricModels.cpp -o main"**.
